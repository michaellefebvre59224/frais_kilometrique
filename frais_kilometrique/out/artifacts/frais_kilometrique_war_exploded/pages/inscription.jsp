    ...
    <section id="formulaire">
        ...
        <form method="POST">
            <fieldset id="zone">
                ...
                <input type="text" name="nom" class="input" id="input_nom" placeholder="entrez votre nom" maxlength="70">
                <br>
                <label class="lab" id="lab_prenom">Prenom : </label>
                <input type="text" name="prenom" class="input" id="input_prenom" placeholder="votre prénom" maxlength="70">
                <br>
                <label class="lab" id="lab_email">Adresse mail : </label>
                <input type="email" name="email" class="input" id="input_mail" placeholder="votre mail" maxlength="70">
                <br>
                <label class="lab" id="lab_email_conf">Confiramtion adresse mail : </label>
                <input type="email" name="email_conf" class="input" id="input_mail_conf" placeholder="votre mail" maxlength="70">
                <br>
                ...
                <input type="password" name="password_conf" class="input" id="input_pw_conf" placeholder="confirmation" maxlength="30" >
